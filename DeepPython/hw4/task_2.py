...
if __name__ == "__main__":
    ...
    with open("artifacts/task_2.txt", "w+") as file:
        ...
        for n_jobs in range(1, 2 * cpu_num + 1):
            ...
            multiprocessing_time = multiprocess_integrate(math.cos, 0, math.pi / 2, n_jobs=n_jobs, n_iter=100_000)[0]
            threads_time = threads_integrate(math.cos, 0, math.pi / 2, n_jobs=n_jobs, n_iter=100_000)[0]
